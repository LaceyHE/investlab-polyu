...
const ScenarioSimulator = () => {
  ...
  return (
    <AppLayout>
      <div className="container flex h-full min-h-0 max-w-7xl flex-col py-12 md:py-20">
        ...
        <AnimatePresence mode="wait">
          {!selectedScenario ? (
            <motion.div key="selection" className="flex-1 overflow-y-auto" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}>
            ...
            <motion.div key="simulation" className="flex min-h-0 flex-1 flex-col overflow-y-auto" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}>
              ...
              {isLoadingData ? (
                ...
                <div className="flex min-h-0 flex-1 flex-col gap-4">
                  <div className="grid min-h-0 gap-4 lg:flex-1 lg:grid-cols-[minmax(0,1fr)_340px]">
